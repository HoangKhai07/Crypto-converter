...
import { IoIosSwap, IoIosClock } from "react-icons/io";
    ...
    if (typeof window !== 'undefined') {
      ...
      if (saved) {
        try {
          ...
          console.log("Failed to parse conversion history")
        }
      }
    }
  }, [])
            ...
            <div className="mt-6 p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-lg font-bold text-gray-800 dark:text-white flex items-center">
                  <IoIosClock className="mr-2" /> Conversion History
                </h3>
                <button
              ...
              <div className="space-y-2 max-h-60 overflow-y-auto">
                {conversionHistory.map((entry, index) => (
                  <div
                    ...
                    className="p-2 rounded-lg bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition cursor-pointer border border-gray-100 dark:border-gray-600"
                  >
                    <div className="flex justify-between">
                      <span className="text-gray-800 dark:text-white font-medium">
                        {entry.amount} {entry.from} → {entry.result.toFixed(6)} {entry.to}
                      </span>
